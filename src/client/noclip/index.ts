...
var getNormalizedVector = function(vector: Vector3) {
    var mag = Math.sqrt(
  ...
  var getCrossProduct = function(v1: { y: number; z: number; x: number; }, v2: { z: number; y: number; x: number; }) {
  ...
  var isNoClip = false;
  var noClipCamera: CameraMp | null;
