...
<template>
    <div
        ...
        <div class="flex flex-row w-full gap-2 items-center">
            <div
                class="flex flex-row items-center bg-gradient-to-br from-pink-800 to-pink-900 text-2xl justify-center w-[5rem] h-[5rem] rounded-md">
                ...
                <div class="flex flex-row w-full items-center gap-1">
                    ...
                    <div class="flex flex-row w-full items-center gap-1">
                        <div class="w-full h-2 bg-white/30 rounded-md">
                            <div class="h-full bg-gradient-to-r from-pink-500 to-pink-800 rounded-md"
                ...
                <div v-if="contextMenu.visible" :style="{ top: `${contextMenu.y}px`, left: `${contextMenu.x}px` }"
                    ...
                    <div class="flex flex-row items-center gap-2 h-1/2 justify-between">
                        ...
                        <button
                            ...
                            class="bg-pink-500 w-1/2 hover:bg-pink-600 text-black font-bold px-2 py-1 rounded-xl">Drop</button>
                    </div>
                </div>
            </div>
            <div class="flex flex-row items-center gap-12 mt-24">
                <div class="flex flex-col gap-2 z-10">
                    <div
                        ...
                        <i
                            class="fa-solid fa-hat-cowboy text-white !text-4xl group-hover:text-pink-600 transition-all"></i>
                    </div>
                    <div
                        class="flex flex-col w-[120px] h-[120px] text-xl group items-center justify-center aspect-square bg-radient-circle-c from-zinc-700/40 border border-zinc-800 to-zinc-950 rounded-md">
                        <svg width="80" height="80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                ...
                                fill="white" class="group-hover:fill-pink-600 transition-colors duration-300"></path>
                            <path
                    ...
                    <div
                        class="flex flex-col w-[120px] h-[120px] text-xl group items-center justify-center aspect-square bg-radient-circle-c from-zinc-700/40 border border-zinc-800 to-zinc-950 rounded-md">
                        <i class="fa-solid fa-shirt text-white !text-4xl group-hover:text-pink-600 transition-all"></i>
                    </div>
                    <div
                        class="flex flex-col w-[120px] h-[120px] text-xl group items-center justify-center aspect-square bg-radient-circle-c from-zinc-700/40 border border-zinc-800 to-zinc-950 rounded-md">
                    ...
                    <div
                        class="flex flex-col w-[120px] h-[120px] text-xl group items-center justify-center aspect-square bg-radient-circle-c from-zinc-700/40 border border-zinc-800 to-zinc-950 rounded-md">
                        <i
                            class="fa-solid fa-shoe-prints text-white !text-4xl group-hover:text-pink-600 transition-all"></i>
                    </div>
                ...
                <div class="flex flex-col gap-2 z-10">
                    <div
                        class="flex flex-col w-[120px] h-[120px] text-xl group items-center justify-center aspect-square bg-radient-circle-c from-zinc-700/40 border border-zinc-800 to-zinc-950 rounded-md">
                        <i class="fa-solid fa-glasses text-white !text-4xl group-hover:text-pink-600 transition-all"></i>
                    </div>
                    <div
                        class="flex flex-col w-[120px] h-[120px] text-xl group items-center justify-center aspect-square bg-radient-circle-c from-zinc-700/40 border border-zinc-800 to-zinc-950 rounded-md">
                        <i class="fa-solid fa-ear text-white !text-4xl group-hover:text-pink-600 transition-all"></i>
                    </div>
                    <div
                        class="flex flex-col w-[120px] h-[120px] text-xl group items-center justify-center aspect-square bg-radient-circle-c from-zinc-700/40 border border-zinc-800 to-zinc-950 rounded-md">
                        <svg class="group-hover:fill-pink-500" width="80" height="80" viewBox="0 0 24 25" fill=""
                    ...
                    <div
                        class="flex flex-col w-[120px] h-[120px] text-xl group items-center justify-center aspect-square bg-radient-circle-c from-zinc-700/40 border border-zinc-800 to-zinc-950 rounded-md">
                        <i class="fa-solid fa-ring text-white !text-4xl group-hover:text-pink-600 transition-all"></i>
                    </div>
                    <div
                        class="flex flex-col w-[120px] h-[120px] text-xl group items-center justify-center aspect-square bg-radient-circle-c from-zinc-700/40 border border-zinc-800 to-zinc-950 rounded-md">
