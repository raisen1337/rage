...
<template>
    <div v-if="showGarage"
        ...
        <!-- Background Effects -->
        <div class="absolute inset-0 z-[1] bg-gradient-to-br from-red-900/20 via-transparent to-zinc-900/30"></div>
        <div
        ...
        <div class="absolute inset-0 z-[2] opacity-20">
            <div v-for="n in 200" :key="n" class="absolute w-1 animate-float h-1 rounded-full bg-red-500/80"
        ...
        <div class="relative z-[10] w-full h-full overflow-auto px-6 py-8 md:p-12">
            ...
            <div class="sticky top-0 z-20 bg-black/60  mb-8 pt-4 pb-6 px-4 rounded-xl border-b border-zinc-800/60">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        <div
                            class="bg-gradient-to-br from-red-600 to-red-800 w-12 h-12 md:w-16 md:h-16 rounded-lg flex items-center justify-center shadow-lg shadow-red-900/30">
                        ...
                        <div class="flex flex-col">
                            <h1 class="text-4xl md:text-6xl uppercase font-bold text-white tracking-wider">
                                <span class="text-red-500">G</span>ARAGE
                            </h1>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="relative">
                            <input type="text" placeholder="Search vehicles..." v-model="searchQuery"
                                class="bg-zinc-900/60 border border-zinc-800/80 text-white rounded-lg py-2 pl-10 pr-4 w-full md:w-64 focus:outline-none focus:ring-1 focus:ring-red-500/50" />
                            <i
            ...
            <div
                ...
                <div v-for="vehicle in filteredVehicles" :key="vehicle.plate"
                    class="group bg-zinc-900/30 overflow-hidden border border-zinc-800/50 hover:border-red-500/50 transition-all duration-300 rounded-xl overflow-hidden hover:shadow-lg hover:shadow-red-900/20 flex flex-col">

                    <!-- Card Header -->
                    <div class="p-4 flex justify-between items-center border-b border-zinc-800/30">
                        <h2 class="text-xl font-bold text-white truncate group-hover:text-red-400 transition-colors">{{
                            vehicle.label }}</h2>
                        <div class="flex gap-2">
                            ...
                            <span
                                class="text-xs px-2 py-1 bg-gradient-to-r from-red-600 to-red-800 rounded-md font-semibold text-white">
                                {{ vehicle.plate }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="p-4 border-t border-zinc-800/30">
                        <div class="flex flex-col gap-2">
                            <button v-if="!vehicle.isOut"
                                ...
                                class="bg-gradient-to-r from-red-600 to-red-800 hover:from-red-500 hover:to-red-700 px-4 py-3 rounded-lg font-bold text-white transition-all duration-200 flex items-center justify-center gap-2 shadow-sm shadow-red-900/30">
            ...
            <div v-if="filteredVehicles.length === 0"
                ...
                <i class="fa-solid fa-car-burst text-4xl mb-4 text-red-500/70"></i>
            ...
            <!-- <div
                ...
                <div class="flex justify-between items-center max-w-screen-2xl mx-auto">
                    ...
                    <div class="flex gap-6">
                        <button class="text-zinc-400 hover:text-red-400 transition-colors">
